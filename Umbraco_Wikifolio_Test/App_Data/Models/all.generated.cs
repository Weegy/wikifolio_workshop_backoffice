...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "b038d2bd47b50cca")]
...
#pragma warning restore 0109
	...
	/// <summary>Airport Repository</summary>
	[PublishedContentModel("airportRepository")]
	public partial class AirportRepository : PublishedContentModel
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "airportRepository";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public AirportRepository(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<AirportRepository, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
	}
